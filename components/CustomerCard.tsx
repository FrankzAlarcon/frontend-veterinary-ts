...
export default function CustomerCard({ customer }: Props) {
  ...
  return (
    <div className="mt-5 bg-white w-full rounded-md text-left p-2 lg:px-5 lg:py-3 space-y-1 md:flex shadow-md">
      ...
      <div className="flex justify-around md:flex-col md:w-1/3 lg:w-3/12">
